let html = `
  ...
  function ListActorsProperties(foldername,requestedpropertiesstringarray){
	...
	for(let actor of folder.content){
	  ...
	  row.insertCell(-1).outerHTML = '<td style="text-align:center;display: block;padding:2px 0px 0px 2px;vertical-align:middle;"><img style="max-width: none;border:0px;width:40px;" src="' + actor.data.img +'"</img></td>';
