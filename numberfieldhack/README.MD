...
* When using the up/down spinners, each change will be processed separately meaning that calculation, and communictaions with all clients will be triggered every time.
