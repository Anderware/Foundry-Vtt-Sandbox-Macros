...
The video below showcases a macro([RollMyDice](https://github.com/Anderware/Foundry-Vtt-Sandbox-Macros/tree/main/Macros/Roll%20My%20Dice)) that uses Foundry Tables to roll dice.
