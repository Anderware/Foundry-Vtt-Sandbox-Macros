...
// 2021-11-30 1.0.1    Ramses800            Fixing 
// **************************************************************** 
                  ...
                  if (property.data.data.datatype == 'simplenumeric') {
                    ...
                    if (actor.data.data.attributes.hasOwnProperty(adjustproperty.propertykey)) {
                      ...
                      if (adjustproperty.adjustmentmode != 'none') {
                        ...
                        if (iPropertyCount == 1) {
                          finalupdatedata = {[`data.attributes.${adjustproperty.propertykey}.value`]: stringvalue,[`data.attributes.${adjustproperty.propertykey}.modified`]: true};
                        } else {
                          updatedata = {[`data.attributes.${adjustproperty.propertykey}.value`]: stringvalue,[`data.attributes.${adjustproperty.propertykey}.modified`]: true};
