...
// 2022-01-29 1.3.0    Ramses800            Updated for SB 0.12.1           
// **************************************************************** 

// example
ExecuteActorRollForSelectedToken('init');
              ...
              if (rollexp!=null){
                if (rollexp.length>0){
                  ...
                  if (hasDialog) {  
                    ...
                    actor.rollSheetDice(rollexp,rollname,rollid,actorattributes,citemattributes,number,target,rollcitemID,tokenID);
                  } 
                }
                else{
