...
If an item in the file has any value in a field the macro will check if the template item has that property and update it if it is not the same as in the file.  
